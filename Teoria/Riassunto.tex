...
\begin{itemize}
    \item + pubblico: accesso esteso a tutte le classi.
    \item \# protetto: accesso consentito solo alle classi che derivano dalla classe originale.
    \item - privato: solo la classe originale può accedere a tali attributi.
\end{itemize}
