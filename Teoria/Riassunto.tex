...
Rappresenta:
\begin{itemize}
    \item tipi di oggetti (classi) del sistema che corrispondono alle entità che esistono nel sistema.
    \item le relazioni statiche tra classi ed i vincoli che si applicano a tali relazioni.
    \item le caratteristiche delle classi: proprietà (attributi e responsabilità dei metodi) e responsabilità.
\end{itemize}
...
\noindent Il nome dell'attributo è l'unico parametro obbligatorio ed il tipo può essere sia un tipo primitivo che una classe definita nello stesso diagramma.

\noindent La molteplicità indica il quantitativo degli attributi di un certo tipo: permette di indicare attributi come array o matrici, il valore default è 1. Il numero minimo e massimo possono essere racchiusi tra parentesi quadre quando il tipo è semplice.
...
\noindent valoreDefault è il valore assegnato all'attributo di default, se nessun valore è specificato durante la creazione.
